...
namespace ABrenneke.BronzeAge.Patches.Mods.RumorHasIt
{
    ...
    public static class ThirdPartyManager_FindCliques_Children
    {
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            foreach (var instruction in instructions)
            {
                ...
                {
                    yield return CodeInstruction.Call(typeof(ThirdPartyManager_FindCliques_Children), nameof(FreeNonSlaveColonistsSpawned));
                }
                else
                {
        ...
        public static IEnumerable<Pawn> FreeNonSlaveColonistsSpawned(MapPawns instance)
        {
            ...
            return instance.FreeColonistsSpawned.Where(p => p.ageTracker?.AgeBiologicalYears >= 15);
        }
    }
}
